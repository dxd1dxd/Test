...
polygon(surf_one, (0, 104, 55), [(430, 8), (406, 84), (415, 87),
 (440, 10)])
aalines(surf_one, (0, 104, 55), True, [(430, 8), (406, 84), (416, 86),
 (441, 11)])
polygon(surf_one, (0, 104, 55), [(408, 96), (391, 151), (408, 157),
 (426, 102)])
aalines(surf_one, (0, 104, 55), True, [(408, 96), (391, 151), (409,
 158), (427, 103)])
polygon(surf_one, (0, 104, 55), [(395, 167), (395, 263), (421, 263),
 (421, 167)])
polygon(surf_one, (0, 104, 55), [(395, 275), (395, 360), (421, 360),
 (421, 275)])
...
arc(surf_one, (0, 104, 55), (438, 6, 344, 208), math.radians(100),
 math.radians(170), 2)
...
arc(surf_one, (0, 104, 55), (3, 42, 409, 375), math.radians(30),
 math.radians(95), 2)
...
arc(surf_one, (0, 104, 55), (415, 120, 176, 291), math.radians(80),
 math.radians(150), 2)
...
arc(surf_one, (0, 104, 55), (203, 161, 195, 181), math.radians(20),
 math.radians(115), 2)

screen.blit(surf_one, (0, 0))

#creat new babmboo
surf_two = pygame.transform.scale(surf_one, (surf_one.get_width()//3,
 surf_one.get_height()//1.5))

surf_two.set_colorkey ((255, 175, 128))
